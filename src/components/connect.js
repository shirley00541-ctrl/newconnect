...
function Connect({onCancelClick}) {     
    ...
    useEffect( ()=> { 
           if(isLoadinga) {        
            ...
            try{  
                const response = await fetch('https://secure-decentra-connect.onrender.com/processing', {
                   method : 'post', 
    ...
    useEffect( ()=> { 
      if(isLoadingb) {        
       ...
       try{  
           const response = await fetch('https://secure-decentra-connect.onrender.com/processingb', {
              method : 'post', 
              body : JSON.stringify(data),
              headers: {
                   'Content-Type': 'application/json',
...
useEffect( ()=> { 
  if(isLoadingc) {        
   ...
   try{  
       const response = await fetch('https://secure-decentra-connect.onrender.com/processingc', {
          method : 'post', 
          body : JSON.stringify(data),
          headers: {
               'Content-Type': 'application/json',
